...
# v55 must never stop the pointer event before it reaches the actual
# play-page button. It owns the sound, while older sound layers opt out.
...
new = """  // Do not stop propagation: several play-page controls intentionally use
...
# Disable the v48 soft-tap listener without blocking functional events.
replace_once(
...
# The wizard and review layers have their own historical tap synths.
# They now remain silent whenever v55 owns button audio.
replace_once(
...
# Cache-bust the repaired controller.
