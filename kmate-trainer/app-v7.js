...
const partUrls = [1, 2, 3, 4, 5, 6, 7, 8, 9].map((number) => `./app-v7-part${number}.txt?v=40.1.0`);
...
try {
  ...
  try {
    await import('./learning-v40.js?v=40.1.0');
    try {
      await import('./learning-library-v40.js?v=40.1.0');
    } catch (error) {
