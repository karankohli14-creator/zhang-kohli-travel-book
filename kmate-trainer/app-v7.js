import { POSITIONS } from './positions-v7.js?v=45.0.0';
...
const partUrls = [1, 2, 3, 4, 5, 6].map((number) => `./app-v7-part${number}.txt?v=45.0.0`);
...
await import('./hotfix-v45.js?v=45.0.0');
